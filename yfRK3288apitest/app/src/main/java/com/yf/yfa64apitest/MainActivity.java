...
public class MainActivity extends Activity {
	...
	private void displaybttest(){
		...
		bt19.setText("set 4 minutes to shutdown and  8boot");
		bt19.setOnClickListener(new OnClickListener() { 
			...
			public void onClick(View v) {
				...
				int[] timeonArray = {mYear, mMonth + 1, mDay, mHour, mMinute+ 8};
				int[] timeoffArray = {mYear, mMonth + 1, mDay, mHour, mMinute + 4};

				Log.e("asd","The manchine will be shutdown at "+ timeoffArray[0]+"/"+timeoffArray[1]+"/"+timeoffArray[2]+":"+timeoffArray[3]+":"+timeoffArray[4]+"\n");
		...
		bt20.setText("set humansensor");
		bt20.setOnClickListener(new OnClickListener() { 
			
			@Override 
			public void onClick(View v) {
				yfapi.yfsetHumanSensor(1000);				
			}
		});
