//package com.example.leng.myapplication2.ui.customWidget;
//
...
//
///**
// * Created by dongkai on 2018/3/1.
// */
//
...
//    protected Rect mHeaderRect = null;
//
...
//        mViewCacheMap = new SparseArrayCompat<>();
//        mOutRect = new Rect();
//        mOutPoint = new Point();
...
//            return;
//        }
//        if(mRvSticker.getAdapter().getItemCount() == 0){
//            return;
//        }
////        if(mRvSticker.getAdapter() instanceof AutoMoreAdapterDecorator){
////            if(((AutoMoreAdapterDecorator)mRvSticker.getAdapter()).getRealItemCount()  == 0 ){
////                return ;
////            }
////        }
//        int position = 0;
...
//            mHeaderRect.top = mOutRect.top;
//            mHeaderRect.left = mOutRect.left;
//            mHeaderRect.right = mOutRect.left + headerView.getWidth();
//            mHeaderRect.bottom = mOutRect.top + headerView.getHeight();
//            //将View绘制到canvas上
//            headerView.draw(c);
//        }else{
//            mHeaderRect.top = 0;
...
//
//        if(parent.getAdapter() instanceof  AutoMoreAdapterDecorator){
//            childCount = ((AutoMoreAdapterDecorator)parent.getAdapter()).getRealItemCount();
//        }
...
//    }
//
//    public boolean isHeaderPositionUnder(int x, int y) {
//        return mHeaderRect.contains(x,y);
//    }
//
//    public View getHeader(RecyclerView mRecyclerView, int position) {
//        return mHeaderHandler.getHeaderView(position,0,mRecyclerView);
//    }
//
//    public boolean findHeaderClickView(View view, int x, int y) {
//        if (mHeaderRect.contains(x, y)) {
//            Rect vRect = new Rect();
//            // 需要响应点击事件的区域在屏幕上的坐标
//            int screenWidth = DeviceUtils.getScreenWidth(PluginCargoContextUtil.get());
//
//            // 固定的view 写死了。勿动
//            vRect.set(screenWidth - dp2px(80), 0, screenWidth , dp2px(44));
//
...
//                dpVal, PluginCargoContextUtil.get().getResources().getDisplayMetrics());
//    }
//
//
//    /**
...
//         */
//        void setHeaderView(int position, int headerViewTag, RecyclerView parent, View headerView);
//
//        /**
...
//         * @return
//         */
//        boolean isBeenDecorated(int lastDecoratedPosition, int nowDecoratingPosition);
//    }
//}