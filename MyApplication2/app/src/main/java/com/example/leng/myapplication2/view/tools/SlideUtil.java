...
public class SlideUtil implements ValueAnimator.AnimatorUpdateListener, Animator.AnimatorListener {
    ...
    public final static class Builder {
        ...
        public SlideUtil build() {
            return new SlideUtil(this);
        }

    }


    private SlideUtil(Builder builder) {
