        ...
        try {
            ...
            if (connection.getResponseCode() == 206) {//文件部分下载，返回码为206
                ...
                while ((len = is.read(buffer)) != -1) {
                    ...
                    bundle.putLong("max",info.getLength());
                    bundle.putLong("progress",info.getFinished());
            ...
            switch (msg.what) {
                case 0x123:
                    if (listener != null) {
                        ...
                        listener.updateProgress(msg.getData().getLong("max"), msg.getData().getLong("progress"));
                    }
                    break;
            }
        }
