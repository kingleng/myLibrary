...
public class IntentUtils {
    ...
    public static boolean gotoPermissionSetting(Activity context) {
        ...
        try {
            ...
            e.printStackTrace();
            Log.e(TAG,"gotoPermissionSetting", e);
            // 跳转失败, 前往普通设置界面
            Intent comSettingIntent=  new Intent(Settings.ACTION_SETTINGS).addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            context.startActivity(comSettingIntent);
            success = false;
