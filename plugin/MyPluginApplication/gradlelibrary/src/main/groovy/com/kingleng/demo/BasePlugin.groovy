...
import com.kingleng.demo.tasks.AssemblePlugin
...
public abstract class BasePlugin implements Plugin<Project> {
    ...
    public void apply(Project project) {
                ...
                new InvocationHandler() {
                    ...
                    Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
                        if ('preVariantWork' == method.name) {
                            ...
                            Log.i 'KLPlugin', "Evaluating KLApk's configurations..."
                            boolean isBuildingPlugin = evaluateBuildingPlugin(appPlugin, project)
                            Log.i 'KLPlugin', "isBuildingPlugin ="+isBuildingPlugin
        ...
        project.extensions.create('klApk', VAExtention)
        ...
        project.afterEvaluate {
            ...
            if (!checkVariantFactoryInvoked) {
                throw new RuntimeException('Evaluating KLApk\'s configurations has failed!')
            }
...
//                Log.i 'VAPlugin', "Found task name '${taskName}' by given name '${it}'"
    ...
    protected final VAExtention getKLApk() {
        return this.project.klApk
    }
