...
public class VerticalScrollTextView extends TextSwitcher implements ViewSwitcher.ViewFactory {
    private final int FLAG_START_AUTO_SCROLL = 0;
    private final int FLAG_STOP_AUTO_SCROLL = 1;
    private final int FLAG_START_FIRST_SCROLL = 2;//第一次滚动不用间隔,后续滚动有间隔

    public float mTextSize = 15 ;
